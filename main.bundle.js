...
let HomeComponent = class HomeComponent {
    ...
    SaveArticle(selectedArticle) {
        ...
        // localStorage.setItem('articles', JSON.stringify(this.articleStore));
